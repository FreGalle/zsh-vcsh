...
zstyle ':completion:*:default' list-prompt '%F{yellow}%m matches (%p)%f'
zstyle ':completion:*:default' select-prompt '%F{yellow}%m selected (%p)%f'
...
zstyle ':completion:*:*:*:*:processes' command 'ps -o pid,tty,time,command -w'
...
# Vim
zstyle ':completion:*:*:vim:*:*files' ignored-patterns '*.class' '*.o'
...
# SSH/SCP/RSYNC
zstyle ':completion:*:(scp|ftp|rsync):*' tag-order 'hosts:-host:host hosts:-domain:domain hosts:-ipaddr:ip\ address *'
zstyle ':completion:*:(scp|ftp|rsync):*' group-order users files all-files hosts-domain hosts-host hosts-ipaddr
