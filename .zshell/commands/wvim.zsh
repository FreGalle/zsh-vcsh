#
# Source: https://github.com/christoomey/dotfiles/blob/master/zsh/configs/wvim.zsh
#
# top-level command. Determines the type of the requested command and then
# attempts to open it in nvim
wvim() {
  command_name="$1"
...
_definition_field_for_pattern() {
  definition=$(grep -En "$2" ~/.zshrc ~/.zshenv ${ZDOTDIR:-$HOME}/**/*.zsh 2>/dev/null)
